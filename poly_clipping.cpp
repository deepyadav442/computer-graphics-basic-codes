                   ...
                   if(index==0)
                   {
                           for(j=0;j<m;j++)
                           {
                                if(!(left_below(e[j].xc,xmin))&&(left_below(e[j+1].xc,xmin)))
                                {
                                     ...
                                     out[k].yc =e[j].yc+(int)(s*(xmin-e[j].xc));//yout=y1+s*(xmin-x1);
                                     out[k].xc=xmin;
                                     k++;
                                     out[k].yc =e[j+1].yc;
                                     out[k].xc =e[j+1].xc;
                                ...
                                else if(!(left_below(e[j].xc,xmin))&&!(left_below(e[j+1].xc,xmin)))//both point outside
                                {cout<<"\nj:  "<<j;
                                }
                                ...
                                else if((left_below(e[j].xc,xmin))&&(left_below(e[j+1].xc,xmin)))//both inside point
                                {
                                	cout<<"\nj:  "<<j;
                                     out[k].yc =e[j+1].yc;
                                     out[k].xc =e[j+1].xc;
